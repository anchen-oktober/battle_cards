...
public class Deck
{
    ...
    {
        GameObject newCard = GameObject.Instantiate(GameController.instance.cardPrefub, GameController.instance.canvas.gameObject.transform);
        ...
        if (card)
        {
            ...
            {
                Debug.LogError("No Animator found! T__T");
                return null;
            }
            return card;
        }
        ...
        {
            Debug.LogError("No card component found! T___T");
            return null;
        }
    }
